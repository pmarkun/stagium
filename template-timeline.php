    ...
    <div id="content" class="page col-full">
		...
		<div id="main" class="col-left">
			...
			<div <?php post_class(); ?>>
				...
				?>
					<li><span class="date"><?php the_time('F j'); ?><sup><?php the_time('S') ?></sup></span> <span class="linked"><a href="<?php the_permalink() ?>"><?php the_title(); ?></a></span> <span class="comments"><?php comments_popup_link(__('Deixe um comentário', 'woothemes'), __('1 comentário', 'woothemes'), __('% comentários', 'woothemes')); ?></span></li>
				<?php
